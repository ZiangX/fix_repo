...
export default ({
  ...
  description = "A web developer is like a builder for websites. We use computer languages to create and design websites that you see on the internet. ",
  ...
  buttonRounded = true,
  features = ["Monday to Friday, 4 hours for 12-weeks", "3 months internship experience", "One mock interview", "Resume Revision"],
  testimonial = {
        ...
        <ContentWithVerticalPadding>
          <Row>
            <TextColumn>
              ...
              <Description>{description}<a href="https://youtu.be/WG5ikvJ2TKA" style={
                {
                  color: "#2563EB",
                  textDecoration: "underline"
                }
              }>Watch this video for more detailed explanation.</a></Description>
